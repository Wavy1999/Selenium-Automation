...
def Bulk_Employee(driver, wait):
    ...
    try:
        ...
        Business_Hub = wait.until(EC.element_to_be_clickable((By.XPATH, "//a[@data-bs-title='Business Hub' and .//span[text()='Business Hub']]")))
        ...
        # Employee Management
        Employee_Management = wait.until(EC.element_to_be_clickable((By.XPATH, "//a[@data-bs-title='Employee Management' and .//span[text()='Employee Management']]")))
        ...
        # Employee List
        add_new_client_bulk = wait.until(EC.element_to_be_clickable((By.XPATH, "//a[.//span[normalize-space(text())='Add New Client (Bulk)']]")))
        ...
        # Upload
        upload_btn = wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="batchOrderForm"]/div[2]/button')))
